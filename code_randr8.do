...
outreg2 [a1 a2 a3 a4 a5 a6 a7 a8] using year_2009, dec(4) bracket excel replace  adjr2
...
outreg2 [a1 a2 a3 a4 a5 a6 a7 a8] using year_2010, dec(4) bracket excel replace  adjr2

*various treatment period
set more off
estimates clear
cd "C:\Users\SESHA.LAPTOP-833NH1RT\Desktop\iimbrr"
use df_full.dta,clear
...
outreg2 [a1 a2 a3 a4 a5 a6 a7 a8] using year_2011, dec(4) bracket excel replace  adjr2


*various treatmetn period
set more off
estimates clear
cd "C:\Users\SESHA.LAPTOP-833NH1RT\Desktop\iimbrr"
use df_full.dta,clear
...
outreg2 [a1 a2 a3 a4 a5 a6 a7 a8] using year_2012, dec(4) bracket excel replace  adjr2
...
outreg2 [a1 a2 a3 a4 a5 a6 a7 a8] using year_2013, dec(4) bracket excel replace  adjr2
