...
*use match_2digit.dta,clear
* use match_4digit.dta,clear
*use match_ind3.dta,clear
use match_replace_false.dta, clear
...
outreg2 [a1 a2 a3 a4 a5 a6 a7 a8] using match_replace_false, dec(4) bracket excel replace  adjr2